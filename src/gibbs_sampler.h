...
public:
    ...
    double sample_intercept(unsigned int sample_index);
    ...
    double get_step_size_intercept() { return step_size_intercept_; }
    ...
    double get_intercept_acc_rate() { return intercept_acc_rate_ / num_samples_; }
...
private:
    ...
    arma::vec intercept_;
    double nu_intercept_;
    double xi_intercept_;
